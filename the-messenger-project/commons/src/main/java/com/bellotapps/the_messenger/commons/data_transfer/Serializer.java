...
/**
 * Defines behaviour for an object that can serialize objects of type {@code T} into {@link String}s.
 *
...
public interface Serializer<T> {
     ...
     * @throws SerializationException If any error occurs while serializing the given {@code object}.
     */
